package com.abdali.microhps.preclearedadjustmentservice.producer;
...
public class PreClearedTransactionProducer {
    ...
    public ListenableFuture<SendResult<Long,String>> sendTransactionEvent(PreClearedTransaction clearedTransaction, String topic) throws JsonProcessingException {

        Long key = (long) clearedTransaction.getId();
        String value = objectMapper.writeValueAsString(clearedTransaction);
