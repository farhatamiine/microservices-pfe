...
@Component
@Slf4j
public class SettlementTransactionProducer {
	@Autowired
    ...
    public ListenableFuture<SendResult<Integer, String>> sendTransactionEvent(TransactionModel transactionModel, String topic) throws JsonProcessingException {
